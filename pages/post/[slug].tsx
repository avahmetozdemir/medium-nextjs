        ...
        >
          ...
          <label className="block mb-5">
            ...
            <input
              ...
              className="shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 outline-none focus:ring"
              type="email"
              placeholder="your_email@medium.com"
            />
          </label>
          <label className="block mb-5">
            ...
            <textarea
              ...
              className="shadow border rounded py-1 px-3 form-textarea mt-1 block w-full ring-yellow-500 outline-none focus:ring"
              placeholder="Enter some long form content for comment"
              rows={8}
            />
          </label>
